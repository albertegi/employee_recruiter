...
public enum ErrorCode {
    ...
    INVALID_CURRENT_PASSWORD("INVALID_CURRENT_PASSWORD","Current Password is invalid", HttpStatus.BAD_REQUEST ), ACCOUNT_ALREADY_DEACTIVATED("ACCOUNT_ALREADY_DEACTIVATED","Account is already deactivated", HttpStatus.BAD_REQUEST),
